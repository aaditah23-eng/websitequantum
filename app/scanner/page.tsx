    ...
    <main className="min-h-screen overflow-hidden bg-[#050505] text-white">
      ...
      <section className="relative px-5 py-8 md:px-8 md:py-10">
        ...
        <div className="mx-auto max-w-7xl py-16">
          ...
          <p className="mt-7 max-w-3xl text-lg leading-8 text-zinc-400">
            Scan domains for TLS posture, certificate health, DNS email security,
            security headers, and real Level 3 hybrid PQC TLS negotiation using
      ...
      <section className="relative mx-auto max-w-7xl px-5 pb-24 md:px-8">
        <div className="grid gap-5 lg:grid-cols-3">
          <InfoCard
            title="What the scanner verifies"
            text="The scanner tests public-facing security posture and attempts a real Level 3 hybrid PQC TLS handshake through your PQC backend."
          />
          <InfoCard
            title="What it does not prove"
            text="It does not prove the entire company is quantum-safe. It only verifies observable posture on the scanned public endpoint."
          />
          <InfoCard
            title="Best use case"
            text="Use it for first-pass domain assessment, vendor due diligence, board-ready reporting, and migration prioritization."
          />
        </div>
      </section>
    </main>
